...
import { Table, Button, Card, Row, Col, Statistic, Tag, Breadcrumb, message, Descriptions } from 'antd';
import { ReloadOutlined, ArrowLeftOutlined, SyncOutlined } from '@ant-design/icons';
    ...
    <div>
      ...
      <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div>
          ...
          <Button icon={<SyncOutlined />} onClick={handleReconcile} style={{ marginRight: 8 }}>Reconcile Stats</Button>
      ...
      <>
        ...
        <Card size="small" title="Configuration" style={{ marginBottom: 24 }}>
            <Descriptions column={4}>
                <Descriptions.Item label="R2 Prefix">{job.r2_prefix}</Descriptions.Item>
                <Descriptions.Item label="Download Mode">{job.download_mode}</Descriptions.Item>
                <Descriptions.Item label="Audio Extension">{job.audio_extension || 'm4a'}</Descriptions.Item>
                <Descriptions.Item label="Video Extension">{job.video_extension || 'mp4'}</Descriptions.Item>
                <Descriptions.Item label="Filename Template" span={4}>{job.filename_template || 'Default'}</Descriptions.Item>
            </Descriptions>
        </Card>
      </>
      )}
